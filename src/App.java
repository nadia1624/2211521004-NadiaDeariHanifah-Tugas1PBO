...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Member Reguler
        System.out.print("Masukkan total belanja Member Reguler: ");
        ...
        // Member Silver
        System.out.print("Masukkan total belanja Member Silver: ");
        ...
        System.out.println("Delivery Cost: " + jarakTujuan2);
        ...
        System.out.println("Delivery Cost: " + jarakTujuan3);
        System.out.println("Cicilan Per Bulan: Rp. " + cicilan3 + "/bulan");

        // Member Platinum
        System.out.print("Masukkan total belanja Member Platinum: ");
        ...
        System.out.println("Delivery Cost: " + jarakTujuan4);
